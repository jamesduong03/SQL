...
INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1001', TO_DATE('2023-06-01', 'YYYY-MM-DD'), 'Paid', 'D', 'Main Street', '123', 'Cityville', '12345', '10.00', 'S1001');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1002', TO_DATE('2023-06-02', 'YYYY-MM-DD'), 'Paid', 'C', 'Park Lane', '456', 'Townsville', '54321', '5.00', 'S1002');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1003', TO_DATE('2023-06-03', 'YYYY-MM-DD'), 'Unpaid', 'D', 'Garden Avenue', '789', 'Villageland', '98765', '0.00', 'S1003');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1004', TO_DATE('2023-06-04', 'YYYY-MM-DD'), 'Paid', 'C', 'Sunset Boulevard', '321', 'Metropolis', '56789', '8.50', 'S1004');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1005', TO_DATE('2023-06-05', 'YYYY-MM-DD'), 'Paid', 'D', 'Oak Street', '567', 'Greenville', '43210', '12.00', 'S1005');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1006', TO_DATE('2023-06-06', 'YYYY-MM-DD'), 'Unpaid', 'C', 'Maple Avenue', '987', 'Hometown', '10987', '7.50', 'S1006');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1007', TO_DATE('2023-06-07', 'YYYY-MM-DD'), 'Paid', 'D', 'River Road', '654', 'Riverside', '87654', '9.50', 'S1007');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1008', TO_DATE('2023-06-08', 'YYYY-MM-DD'), 'Paid', 'C', 'Mountain View Drive', '234', 'Mountaintop', '54321', '6.00', 'S1008');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1009', TO_DATE('2023-06-09', 'YYYY-MM-DD'), 'Unpaid', 'D', 'Broadway', '876', 'Center City', '12345', '0.00', 'S1009');

INSERT INTO ORDERS (order_no, ordet_date, order_payment_status, collection_type, dest_street_name, dest_street_number, dest_city, dest_postcode, shipping_price, session_no)
VALUES ('O1010', TO_DATE('2023-06-10', 'YYYY-MM-DD'), 'Paid', 'C', 'Market Street', '543', 'Downtown', '98765', '7.00', 'S1010');

-- Inserting BOOKING data

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100001', '10001', 'O1001', TO_DATE('2023-06-01', 'YYYY-MM-DD'), TO_DATE('2023-06-01 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Family Portrait', 150.00, 'Paid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100002', '10002', 'O1002', TO_DATE('2023-06-02', 'YYYY-MM-DD'), TO_DATE('2023-06-02 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Engagement Shoot', 200.00, 'Paid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100003', '10003', 'O1003', TO_DATE('2023-06-03', 'YYYY-MM-DD'), TO_DATE('2023-06-03 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Graduation Photos', 100.00, 'Unpaid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100004', '10004', 'O1004', TO_DATE('2023-06-04', 'YYYY-MM-DD'), TO_DATE('2023-06-04 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Professional Headshots', 80.00, 'Paid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100005', '10005', 'O1005', TO_DATE('2023-06-05', 'YYYY-MM-DD'), TO_DATE('2023-06-05 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Maternity Photoshoot', 120.00, 'Paid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100006', '10006', 'O1006', TO_DATE('2023-06-06', 'YYYY-MM-DD'), TO_DATE('2023-06-06 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Fashion Photoshoot', 180.00, 'Unpaid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100007', '10007', 'O1007', TO_DATE('2023-06-07', 'YYYY-MM-DD'), TO_DATE('2023-06-07 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Product Photography', 90.00, 'Paid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100009', '10009', 'O1009', TO_DATE('2023-06-09', 'YYYY-MM-DD'), TO_DATE('2023-06-09 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Birthday Party Photos', 150.00, 'Unpaid');

INSERT INTO booking (booking_no, account_no, order_no, session_date, session_start, reason, price, booking_payment_status)
VALUES ('B100010', '10010', 'O1010', TO_DATE('2023-06-10', 'YYYY-MM-DD'), TO_DATE('2023-06-10 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'Outdoor Wedding Shoot', 250.00, 'Paid');
...
INSERT INTO photograph (photo_unique_no, photo_size, photo_colour, photo_finish, quantity)
VALUES ('P100002', '5x7', 'Black and White', 'Glossy', '3');
...
WHERE o.ordet_date = TO_DATE('2023-06-15', 'YYYY-MM-DD');
